...
interface UnblockBlockModalProps {
  visible: boolean;
  onClose: () => void;
  onConfirm: () => void;
}

export default function UnblockBlockModal({ visible, onClose, onConfirm }: UnblockBlockModalProps) {
  return (
    <Modal
      visible={visible}
      transparent
    ...
    >
      <View style={styles.overlay}>
        <View style={styles.dialogBox}>
          <Text style={styles.title}>DO YOU WANT TO UNBLOCK THIS USER ?</Text>
